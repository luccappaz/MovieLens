...
Clique em Trigger DAG na DAG da Silver.

O Airflow irá processar os dados no MinIO e acionará automaticamente a DAG da Gold para treinar o modelo de recomendação.
...
├── ingest_movielens_raw.py # Script para fazer o Download do banco de dados para o MinIO
├── docker-compose.yaml # Infraestrutura
└── README.md # Este ficheiro

Desenvolvido com ☕ e focado em Engenharia de Dados Moderna.
